<template>
  <div class="login-container">
    <div style="position: fixed; width: 100%; height: 100%; overflow: hidden; background: url(login.jpg); background-repeat: repeat-y; background-size: 100% auto;" />
    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-tooltip v-model:visible="capsTooltip" :content="$t('common.tips.caps_lock_is_on')" placement="right" manual>
...
export default {
  ...
  computed: {
    application_name() {
      return this.$settings['SYSTEM_TITLE'] || settings.title
    },
    settings() {
      return settings
    }
  ...
  methods: {
    ...
    handleLogin() {
      const formData = deepClone(this.loginForm)
